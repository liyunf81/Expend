 ...
 */
static force_inline GPEncodingNSType GetNSType(Class cls)
{
 ...
 */
static force_inline BOOL GPEncodingTypeIsCNumber(GPEncodingType type)
{
...
static void GPModelSetWithPropertyMetaArray(const void* _propertyMeta,void* context)
{
    ...
    if (propertyMeta.mappedToKeyArray) {
        ...
        value = [dic objectForKey:propertyMeta.mappedToKey];
    }
    if (value) {
        __unsafe_unretained id model = (__bridge id)tmpContext->model;
